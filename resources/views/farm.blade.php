...
<body style="background: black">
    ...
    <div class="cover" id="map" >
        <section>
			<div id="apDiv11">
				<canvas class="char" id="FarmHumidity-line-chart" width="600" height="220"></canvas>
				<canvas class="char" id="FarmWaterLevel-line-chart" width="600" height="220"></canvas>
			</div>
			<div id="apDiv5">
				<canvas class="char" id="FarmTemperature-line-chart" width="600" height="220"></canvas>
				<canvas class="char" id="FarmFlow-chart" width="600" height="220"></canvas>
			</div>
          	<div id="apDiv2">
                <!--menu-->
                <table>
